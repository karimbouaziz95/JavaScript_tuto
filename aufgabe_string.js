...
let pos_plus = shopping.indexOf("+++")
console.log(pos_plus)
...
console.log(shopping.substr(0,pos_plus) + shopping.substr(pos_plus + 3))
console.log(shopping.slice(0,pos_plus) + shopping.slice(pos_plus + 3))
