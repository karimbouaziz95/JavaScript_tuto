...
console.log(" - " + Math.floor(amount / 200) + "x 2euro")
amount = amount - Math.floor(amount / 200) * 200

console.log(" - " + Math.floor(amount / 100) + "x 1euro")
amount = amount - Math.floor(amount / 100) * 100

console.log(" - " + Math.floor(amount / 50) + "x 50cents")
amount = amount - Math.floor(amount / 50) * 50

console.log(" - " + Math.floor(amount / 30) + "x 30cents")
amount = amount - Math.floor(amount / 30) * 30

console.log(" - " + Math.floor(amount / 20) + "x 20cents")
amount = amount - Math.floor(amount / 20) * 20

console.log(" - " + Math.floor(amount / 10) + "x 10cents")
amount = amount - Math.floor(amount / 10) * 10

console.log(" - " + Math.floor(amount / 5) + "x 5cents")
amount = amount - Math.floor(amount / 5) * 5

console.log(" - " + Math.floor(amount / 2) + "x 2cents")
amount = amount - Math.floor(amount / 2) * 2

console.log(" - " + Math.floor(amount / 1) + "x 1cents")
