...
// Schreibe deinen Code hier
let byeStudent = "Laura"

if(students1.indexOf(byeStudent) !== -1){
    students1.splice(students1.indexOf(byeStudent), 1)
}
else if(students2.indexOf(byeStudent) !== -1){
    students2.splice(students2.indexOf(byeStudent), 1)
}
...
else if(numberOfStudents > 1 && numberOfStudents < 6){
